...
const OurStory = () => (
  <div className="min-h-screen bg-[#0f172a] text-white flex flex-col">
    ...
    <main className="container mx-auto px-6 pt-28 pb-16 space-y-6 max-w-4xl">
      ...
      <p className="text-white/80">3DGENI was started to turn children's drawings and ideas into delightful characters. We focus on privacy, safety, and playful creativity.</p>
